...
public class AdministrativoApp {
    public static void main(String[] args) {
        ...
        pessoa1.setNome("Leonardo Quadros");
        pessoa1.setEmail("leo@jogador.com");
        pessoa1.setIdade(24);
        pessoa1.setCpf("123.456.789-10");
        pessoa1.setDataNascimento(LocalDate.of(1998, 01, 01));

        Pessoa pessoa2 = new Pessoa();
        pessoa2.setNome("Lucas");
        pessoa2.setEmail("lucas@jogador.com");
        pessoa2.setIdade(29);
        pessoa2.setCpf("101.198.555-13");
        pessoa2.setDataNascimento(LocalDate.of(1990, 5, 20));
        ...
        // 3) Update Pessoa CPF de 123.456.789-10 to 123.456.789-11
        System.out.println("---->>> 3 - Atualizando o CPF da Pessoa 2");
        pessoa2.setId(2);
        pessoa2.setCpf("123.456.789-11");
